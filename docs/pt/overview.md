...
No editor do CMS, não é visível nenhuma barra de separadores. Em vez disso, uma
moldura tracejada destaca o grupo, com o respetivo título do separador como etiqueta, para que
cada coluna continue a ser acessível individualmente durante a edição. A
barra de separadores propriamente dita só aparece na página publicada.
